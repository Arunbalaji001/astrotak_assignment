...
class EditProfileFormPage extends StatefulWidget{
  const EditProfileFormPage({Key? key}) : super(key: key);
  @override
                  ...
                  child: Container(
                    ...
                    child:Form(
                      ...
                      Column(
                        ...
                        children: [
                          Consumer<RelationsProvider>(
                            builder: (context,model,child){
                              if(model.selectedrelative!=null){
                                Relatives editrelative=model.selectedrelative!;
                                dropdownvalue = editrelative.gender??'MALE';
                                int newindx=0;
                                if(editrelative.relationId!=null) {
                                  newindx = editrelative.relationId! - 1;
                                }
                                ampm=(editrelative.birthDetails?.meridiem)=='AM'?true:false;
                                dropdownvalue2=items2[newindx];
                                namectrler.text=editrelative.fullName??'';
                                dayctrler.text=editrelative.birthDetails?.dobDay.toString()??'';
                                monthctrler.text=editrelative.birthDetails?.dobMonth.toString()??'';
                                yearctrler.text=editrelative.birthDetails?.dobYear.toString()??'';
                                hourctrler.text=editrelative.birthDetails?.tobHour.toString()??'';
                                mintsctrler.text=editrelative.birthDetails?.tobMin.toString()??'';
                                selectedplace=Placez(placeId:editrelative.birthPlace?.placeId.toString()??"",placeName:  editrelative.birthPlace?.placeName.toString()??"");
                                return Column(
                                children: [
                                  Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              InkWell(onTap: ()=>setState(() {
                                                model.selectedrelative!.birthDetails!.meridiem='AM';
                                                if(!ampm)
                                                {ampm=true;
                                                }
                                              }),
                                              ...
                                              InkWell(
                                                onTap:()=>setState(() {
                                                  model.selectedrelative!.birthDetails!.meridiem='PM';
                                  ...
                                  Container(
                                    ...
                                    Autocomplete<Placez>(
                                        optionsBuilder: (TextEditingValue textEditingValue) async {
                                          List<Placez> fxt= await model.getplaces(textEditingValue.text);
                                          return fxt;
                                        ...
                                        fieldViewBuilder: (
                                          ...
                                          if(selectedplace!=null &&selectedplace!.placeName!=null)
                                          {
                                            fieldTextEditingController.text=selectedplace!.placeName;
                                          }
                                        ...
                                        onSelected: (Placez selection) {
                                          ...
                                          model.selectedrelative!.birthPlace=BirthPlace(placeName: selectedplace!.placeName, placeId: selectedplace!.placeId);
                                        },
                                        optionsViewBuilder: (
                                            BuildContext context,
                                              ...
                                              DropdownButton(
                                                  ...
                                                  onChanged: (String? newValue) {
                                                    setState(() {
                                                      ...
                                                      model.selectedrelative!.relationId=items2.indexOf(newValue)+1;
                                                    });
                                                  }
                                    ...
                                    onTap:() async{
                                      if(_formKey.currentState!.validate()){
                                        if(selectedplace==null){
                                          ...
                                          relid=relid+1;
                                          print('indx'+relid.toString());
                                          setState(() {
                                            loading=true;
                                          });
                                          model.selectedrelative!.birthDetails=mx;
                                          model.selectedrelative!.relationId=relid;
                                          model.selectedrelative!.relation=dropdownvalue2;
                                          addapistat vbx= await Provider.of<RelationsProvider>(context,listen: false).updaterelation();
                                ...
                                return Container(
                                  child: Center(
                                    child: Column(
                                      children: [
                                        Icon(Icons.error_outline_sharp,color: Colors.grey,),
                                        SizedBox(height: 24,),
